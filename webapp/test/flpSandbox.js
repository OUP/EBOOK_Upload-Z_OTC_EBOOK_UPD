			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"EBOOKUpload-display": {
								"semanticObject": "EBOOKUpload",
								"action": "display",
								"description": "E-Book Upload application",
								"title": "EBOOK Upload",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=oup.otc.zotcebookupld",
									"url": sap.ui.require.toUrl("oup/otc/zotcebookupld/")
								}
							}
						}
					}
