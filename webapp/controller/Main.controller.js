sap.ui.define(
  ...
  function (
    ...
    return Controller.extend("oup.otc.zotcebookupld.controller.Main", {
      onInit: function () {
        // view
        _oView = this.getView();
      ...
      onResetPress: function () {
        ...
        // customer - value help
        _oViewModel.setProperty("/customerVS", "None");
        ...
        _oDataModel.setProperty(`${sPath}/Customer`, "");
        _oDataModel.setProperty(`${sPath}/PriceListType`, "");
        _oDataModel.setProperty(`${sPath}/GratisCheckBox`, false);
        ...
        if (oFiles.length !== 0) {
          ...
          if (isNaN(sTemplateID, 10)) {
            const sMessage =
              ...
              "\n\nSample file name with template id - 'XXX_FileName'";
      ...
      onUploadPress: function () {
        try {
          ...
          const sCustomer = _oDataModel.getProperty(`${sPath}/Customer`);
          const sPriceList = _oDataModel.getProperty(`${sPath}/PriceListType`);
          const bGratis = _oDataModel.getProperty(`${sPath}/GratisCheckBox`);

          // validation fields
          let bCustomerValid = true;
          ...
          if (!bCustomerValid || !bSalesOrgValid || !bFileValid) {
            throw "validation failed!";
          }

          // trigger upload
          this._fnPost(sSalesOrg, sCustomer, sPriceList, bGratis, sFileName);
      ...
      _fnPost: function (sSalesOrg, sCustomer, sPriceList, bGratis, sFileName) {
        // ajax setup
        jQuery.ajaxSetup({
          cache: false,
        });
        ...
        jQuery.ajax({
          ...
          beforeSend: (xhr) => {
            ...
            xhr.setRequestHeader(
              "slug",
              `${_sTemplateID}|${sSalesOrg}|${sCustomer}|${sPriceList}|${bGratis}`
            );
          },
          success: (oData) => {
            try {
